                                            ...
                                            <CardHeader>
                                                <div className="widget-content">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            <div className="widget-heading">Siva Krishna</div>
                                                            <div className="widget-subheading">Sr Software Engineer</div>
                                                        </div>
                                                        <div className="widget-content-right me-2">
                                                            <Button className="btn-pill btn-shadow btn-shine btn btn-focus" size="md">
                                                                Logout
                                                            </Button>
                                                        </div>
                                                    </div>
