...
const FileManagement = () => {
    ...
    let handleSubmit = () => {
        ...
        files.map(file => {
            ...
            data.append('file_template_id', templateName);
            data.append('file_name', file, '1.' + ext);
            data.append('original_file_name', file.name);
            data.append('file_format', file.type);
            data.append('file_size', String(file.size));
            data.append('is_delete', "0")
            submitSingleFiles(data)
